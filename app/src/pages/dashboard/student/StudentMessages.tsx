...
const StudentMessages: React.FC = () => {
  ...
  const markAsRead = async (messageId: string) => {
    try {
      await api.put(API.MESSAGE_READ(messageId));
      fetchMessages(tab);
    } catch (err: any) {
        ...
        <div className="mb-6">
          <div className="flex items-center gap-4 mb-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Mes Messages</h1>
            </div>
          </div>
          <p className="text-gray-600 dark:text-gray-400">Boîte de réception et messages envoyés</p>
        </div>
